import { CommonContentClientConfig, ContentClientConfigOptions } from './config';
 ...
 */
export declare class ContentClient implements GetContentItemById, GetContentItemByKey {
     ...
     */
    constructor(config: ContentClientConfigOptions);
    /**
     ...
     */
    getContentItemById<T extends ContentBody = DefaultContentBody>(id: string): Promise<ContentItem<T>>;
    /**
     ...
     * @param id Unique id of the Content Item or Slot to load
     */
    getContentItemByKey<T extends ContentBody = DefaultContentBody>(key: string): Promise<ContentItem<T>>;
    /**
     ...
     * @returns
     */
    filterContentItems<Body = any>(filterBy: FilterByRequest): Promise<FilterByResponse<Body>>;
    /**
     *  This function will help construct requests for filtering Content Items or Slots
     *
     ...
     */
    filterBy<Body = any, Value = any>(path: string, value: Value): FilterBy<Body>;
    /**
     *
     *  This function will help construct requests for filtering Content Items or Slots
     *
     ...
     */
    getContentItemsById<Body = any>(ids: Array<string>): Promise<FetchResponse<Body>>;
    /**
     ...
     * @returns `Promise<FetchResponse<Body>>`
     */
    getContentItemsByKey<Body = any>(keys: Array<string>): Promise<FetchResponse<Body>>;
    /**
     ...
     * @returns `Promise<FetchResponse<Body>>`
     */
    getContentItems<Body = any>(requests: FetchRequest['requests'], parameters?: FetchRequest['parameters']): Promise<FetchResponse<Body>>;
    /**
     ...
     * @returns `Promise<FetchResponse<Body>>`
     */
    fetchContentItems<Body = any>(body: FetchRequest): Promise<FetchResponse<Body>>;
    /**
     ...
     * @hidden
     */
    protected createContentMapper(config: CommonContentClientConfig): ContentMapper;
}
