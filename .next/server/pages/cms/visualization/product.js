...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_core__WEBPACK_IMPORTED_MODULE_1__]);
_components_core__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
async function getServerSideProps(context) {
    ...
    if (res) {
        ...
        res.writeHead(301, {
            Location: `/product/${sku}?` + queryArgs.map(([key, value])=>`${key}=${encodeURIComponent(value)}`).join("&")
        });
        res.end();
    }
    return {
...
var __webpack_exports__ = __webpack_require__.X(0, [473,675,952,664,638,153,322,506,298], () => (__webpack_exec__(3238)));
