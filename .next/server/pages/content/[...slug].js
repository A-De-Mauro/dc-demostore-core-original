...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ContentPage),
...
/* harmony import */ var _lib_page_errors_create404Error__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7360);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_core__WEBPACK_IMPORTED_MODULE_1__, _components_cms_modern__WEBPACK_IMPORTED_MODULE_3__]);
([_components_core__WEBPACK_IMPORTED_MODULE_1__, _components_cms_modern__WEBPACK_IMPORTED_MODULE_3__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
async function getServerSideProps(context) {
    ...
    const data = await (0,_lib_page_fetchStandardPageData__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)({
        content: {
            page: {
                key: `content/${deliveryKey}`
            }
        }
    }, context);
    if (!data.page) {
        return (0,_lib_page_errors_create404Error__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)(data, context);
    }
    return {
        props: {
            ...data
...
function ContentPage({ content  }) {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_cms_modern__WEBPACK_IMPORTED_MODULE_3__/* .ContentBlock */ .b0, {
        content: content.page
    });
};
ContentPage.Layout = _components_core__WEBPACK_IMPORTED_MODULE_1__/* .Layout */ .Ar;
...
var __webpack_exports__ = __webpack_require__.X(0, [473,675,952,664,638,153,322,506,298], () => (__webpack_exec__(1451)));
